...
const BecomeVolunteer = () => {
    return (
        <div className='mt-16 flex flex-col md:flex-row lg:flex-row font-mont px-8 lg:px-14'>
            ...
            <div className='basis-1/2 pl-0 lg:pl-9'>
                <p className='text-[#fd6711] uppercase font-medium pt-6 md:pt-0 lg:pt-0'>Become a volunteer</p>
